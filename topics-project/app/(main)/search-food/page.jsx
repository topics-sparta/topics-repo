  ...
  return (
    <div className="w-full h-full bg-customPrimary">
      <div className="flex items-center justify-center flex-col pt-20">
        ...
        <div>
          <input
            className="w-[650px] h-[60px] text-[24px] text-[#FFF7ED] placeholder-[#FFF7ED] bg-[#D79C59] rounded-[999px] px-10 outline-none drop-shadow-2xl "
        ...
        {/* for buttons */}
        <div className="flex  items-center justify-center w-[75%] mt-14 space-x-10 ">
          <div className="flex cursor-pointer flex-col items-center justify-center w-[33%] h-[131.25px] bg-[#D79C59] bg-opacity-[20%] rounded-md ">
            <svg
